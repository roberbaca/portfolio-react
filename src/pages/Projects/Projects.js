...
const Projects = () => {
  ...
  return (
    ...
    <section className = "projects">    
        ...
        <div className='card'>
            {window.screen.width > 768 && <div className='card-img-container'><img className="card-img" src={require('../../assets/card2.png')} alt="card-img" /></div>}
          ...
          <div className='card'>
            {window.screen.width > 768 && <div className='card-img-container'><img className="card-img" src={require('../../assets/card3.png')} alt="card-img" /></div>}
            <div className='card-info'>
              <div className='card-data'>
                <div className='card-header'>
          ...
          <div className='card'>
            {window.screen.width > 768 && <div className='card-img-container'><img className="card-img" src={require('../../assets/card1.png')} alt="card-img" /></div>}
            <div className='card-info'>
              <div className='card-data'>
                <div className='card-header'>
